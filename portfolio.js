...
const greeting = {
  ...
  resumeLink: "https://drive.google.com/file/d/13c8ov4-rT12bwUerB0uYb7HkY6cS_gBm/view?usp=sharing", 
...
const degrees = {
  degrees: [
    ...
    {
      title: "Awarded research grant of 3,50,000 INR for my research work on Identification using Gait Energy Image",
      //subtitle: "secured 1st rank nationally and a cash prize of 1,00,000 INR ",
      logo_path: "Gait.png",
      alt_name: "Team MAVERICK",
      //duration: "2016 - Present",
    ...
    
    {
      ...
      subtitle: "Inter-college competition at School of Engineering and Applied Science, Ahmedabad University, March 2019 ",
      logo_path: "AU.png",
      alt_name: "Team MAVERICK",
      //duration: "2016 - Present",
      descriptions: [
...

    {
      ...
      website_link: "https://github.com/rushirajsherlocked/TCS-HumAIn---Taxonomy-Classification",
    },
...
const experience = {
  ...
  sections: [
    ...
    // },
    {
      ...
      experiences: [
        {
          title: "Research Intern (Satellite Image Processing & Machine Learning)",
          company: "Small Satellite Research Laboratory (SSRL) - UGA ",
          company_url: "http://www.smallsat.uga.edu",
          logo_path: "SSRL.png",
          duration: "Internship delayed temporarily due to COVID (Expected continual: Nov 2020)",
        ...
        },
        {
          ...
          company: "Centre of Excellence - Artificial Intelligence, Indian Army",
        ...
        },
        {
          ...
          company: "Bhaskaracharya Institute for Space Applications and Geo-Informatics (BISAG)",
          // company_url:
